  ...
  try {
    ...
    const html = `
      <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto;padding:24px;">
        ...
        <p style="color:#94a3b8;font-size:12px;margin-top:24px;">Sent by Contract Clarity — Contract Intelligence</p>
      </div>
    `;
    ...
    const emailRes = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Contract Clarity <alerts@contractclarity.app>",
        to: [to],
...
<body>
  <div style="display:flex;justify-content:space-between;align-items:flex-start">
    <div>
      ...
      <div class="subtitle">Generated by Contract Clarity — ${new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</div>
    </div>
